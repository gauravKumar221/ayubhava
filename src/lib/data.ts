...
export const products = [
  {
    ...
    description: "Experience the ultimate night's rest with our signature melts. Formulated with natural extracts to support a healthy sleep cycle.",
    pattern: "Dissolvable Strips",
    material: "Valerian Root, Melatonin, L-Theanine",
    sizeFit: "30 Strips per pack"
  },
  {
    id: 'sleep-2',
    category: "Sleep & Stress",
    subCategory: "Wholefood Multivitamins",
    ...
    isHighlyReordered: true,
    description: "Support your muscle recovery and cognitive health with our triple-magnesium blend.",
    pattern: "Capsules",
    material: "Magnesium Malate, Glycinate, Citrate",
    sizeFit: "60 Capsules"
  },
  {
    id: 'sleep-3',
    ...
    description: "A gentler dose for focused relaxation before sleep.",
    pattern: "Dissolvable Strips",
  ...
  },
  {
    ...
    isHighlyReordered: true,
    description: "Our best-selling marine collagen for radiant skin and healthy hair.",
    pattern: "Fine Powder",
    material: "Sustainably sourced fish collagen",
    sizeFit: "250g Jar"
  },
  {
    id: 'protein-1',
    category: "Vegan Protein Isolate",
    subCategory: "Vegan Protein Isolate",
    ...
    isHighlyReordered: false,
    description: "High-performance vegan protein for the modern athlete.",
    pattern: "Protein Powder",
    material: "Pea & Rice Protein",
    sizeFit: "1kg Bag"
  },
  {
    id: 'imm-1',
    ...
    isHighlyReordered: true,
    description: "Fortify your body's natural defenses with our daily immunity boost.",
    pattern: "Capsules",
    material: "Vitamin C, Zinc, Elderberry",
    sizeFit: "60 Capsules"
  },
  {
    id: 'gut-1',
    ...
    isHighlyReordered: true,
    description: "Optimize your digestive wellness with 4 billion CFU of premium probiotics.",
    pattern: "Powder",
    material: "Probiotic Blend, Prebiotic Fiber",
    sizeFit: "30 Servings"
  }
];
